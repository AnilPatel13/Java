...
import com.FoodPlaza.Dao.CustomerDoaImpl;
...
public class CommonCustomerServlet extends HttpServlet {
	...
	Customer21136 c=new Customer21136();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(action!=null&&action.equalsIgnoreCase("edit"))
		{
			int customerid=Integer.parseInt(request.getParameter("customerid"));
		     Customer21136 c=cd.getcustomerbyId(customerid);
		...
		//HttpSession s=request.getSession();
	        List<Customer21136>clist=cd.DisplayallCustomer();
