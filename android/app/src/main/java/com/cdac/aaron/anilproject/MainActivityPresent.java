...
public class MainActivityPresent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_present);
        getSupportActionBar().hide();

        Toast.makeText(MainActivityPresent.this,"Present",Toast.LENGTH_SHORT).show();
        ...
        switchBeginningEnd.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked)
                {
                    ...
                    Toast.makeText(MainActivityPresent.this,"begaining",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    switchBeginningEnd.setText("end");
                    switchBegEnd = "end";
                    Toast.makeText(MainActivityPresent.this,"end",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buttonCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentGraph = new Intent(MainActivityPresent.this, NavigationActivityPresent.class);

                SharedPreferences sharedPreferences = getSharedPreferences("dataPresent",MODE_PRIVATE);
